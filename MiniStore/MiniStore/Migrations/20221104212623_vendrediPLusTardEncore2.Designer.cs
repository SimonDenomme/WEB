...
namespace MiniStore.Migrations
{
    ...
    [Migration("20221104212623_vendrediPLusTardEncore2")]
    partial class vendrediPLusTardEncore2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1929cdc5-e462-4db9-aff9-eb205c1d9d39",
                            ConcurrencyStamp = "73a4ba38-59f6-48d1-8001-18f2974999b2",
                            Name = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "f9e7382e-8848-43a7-8936-ee6c35cc3042",
                            RoleId = "1929cdc5-e462-4db9-aff9-eb205c1d9d39"
                        });
                });
            ...
            modelBuilder.Entity("MiniStore.Domain.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f9e7382e-8848-43a7-8936-ee6c35cc3042",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "46db062b-9547-4153-bb61-657a7e020ae1",
                            Email = "admin@test.ca",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@TEST.CA",
                            NormalizedUserName = "ADMIN@TEST.CA",
                            PasswordHash = "AQAAAAEAACcQAAAAED0BPW/kQ3YwFrAGe89L6dewNbDeAAV807822jMN1NZklWn75VIoQsW1c0+X0GwkzA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "f988f718-219f-469e-92c8-ac6b3855a720",
            ...
            modelBuilder.Entity("MiniStore.Domain.ApplicationUser", b =>
                {
                    b.HasOne("MiniStore.Domain.Address", "Address")
                        .WithMany()
